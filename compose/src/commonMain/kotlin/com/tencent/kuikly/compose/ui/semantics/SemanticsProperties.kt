...
//    val InsertTextAtCursor = ActionPropertyKey<(AnnotatedString) -> Boolean>("InsertTextAtCursor")
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            "OnImeAction",
            "com.tencent.kuikly.compose.ui.semantics.SemanticsActions.OnImeAction",
        ),
 ...
 * [onNodeWithTag][com.tencent.kuikly.compose.ui.test.onNodeWithTag].
 * - For newer AccessibilityNodeInfo-based integration test frameworks, it can be matched in the
 * extras with key "com.tencent.kuikly.compose.ui.semantics.testTag"
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "com.tencent.kuikly.compose.ui.semantics.onImeAction",
        "com.tencent.kuikly.compose.ui.text.input.ImeAction",
    ),
    level = DeprecationLevel.ERROR,
)
