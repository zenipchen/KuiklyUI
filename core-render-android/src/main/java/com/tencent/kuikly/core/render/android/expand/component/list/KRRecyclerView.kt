...
class KRRecyclerView : RecyclerView, IKuiklyRenderViewExport, NestedScrollingChild2,
    ...
    /**
     * 检查 target 及其所有子滚动视图能否在指定方向滚动（纵向）
     * 
     * 修复嵌套滚动问题：当 Kuikly 子容器内嵌套 Hippy ScrollView 时，
     * 需要检查所有层级的滚动视图是否都到达边缘，而不是只检查 Kuikly 子容器本身
     * 
     * @param target 目标视图（Kuikly 子容器）
    ...
    /**
     * 检查 target 及其所有子滚动视图能否在指定方向滚动（横向）
     */
